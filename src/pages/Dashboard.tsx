      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-muted-foreground">平均处理时长</span>
                ...
                todayMeetings.map((meeting) => (
                  ...
                  >
                    <div className="flex h-12 w-12 flex-shrink-0 flex-col items-center justify-center rounded-lg bg-primary/10 text-primary">
                      <span className="text-xs font-medium">{meeting.startTime}</span>
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground mt-0.5">{meeting.roomName}</p>
                    </div>
                  </div>
                ))
              )}
            ...
            {recentNotifications.map((notification) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground mt-0.5 line-clamp-1">{notification.content}</p>
