...
export default function UserManagement() {
  ...
  const {
    ...
    queryKey: [
      "users",
      { search: searchQuery, department: selectedDepartment, page },
    ],
    queryFn: () =>
      apiGetUsers({
        search: searchQuery || undefined,
        department:
          selectedDepartment !== "全部" ? selectedDepartment : undefined,
        page,
        limit: 50,
      }),
  });
        ...
        <DialogContent>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label>新部门</Label>
              <Select
                value={updateFormData.department || undefined}
                onValueChange={(value) =>
                  setUpdateFormData({ ...updateFormData, department: value })
                }
              >
                <SelectTrigger>
            ...
            <div className="grid gap-2">
              <Label>新角色</Label>
              <Select
                value={updateFormData.role || undefined}
                onValueChange={(value) =>
